...
from restry.custom_models import RC as RC
...
from restry.utils_data import scalar_to_scalar, vector_to_vector, sequence_to_sequence, x_to_x
...
model_rc.compile(optimizer='ridge', metrics=['mean_squared_error'], discard_transients=discard_transients)
...
"""
from restry.cross_validation import cross_val
